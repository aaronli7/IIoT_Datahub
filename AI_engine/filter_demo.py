...
butter_hp = dsp.butter_highpass_filter()
butter_lp = dsp.butter_lowpass_filter()
butter_bp = dsp.butter_bandpass_filter()
butter_bs = dsp.butter_bandstop_filter()
cheby_1 = dsp.cheby1_filter()
cheby_2 = dsp.cheby2_filter()
